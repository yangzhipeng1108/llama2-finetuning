...
from utils.utils import print_rank_0, to_device, save_hf_format, set_random_seed, get_all_reduce_mean, \
    get_optimizer_grouped_parameters, save_zero_three_model, load_hf_tokenizer, load_hf_chatglm_tokenizer,save_zero_three_model_lora
...
def main():
    ...
    if args.do_eval:
        ...
        #     labels = labels[:, 1:].reshape(-1)
        #     preds = preds[:, :-1].reshape(-1)
        #     return accuracy_score(labels, preds, normalize=True, sample_weight=False)
    ...
    print_rank_0(f'waste time:  {time}', args.global_rank)
    ...
    if args.output_dir is not None:
        ...
        if args.zero_stage == 3:
            ...
            save_zero_three_model_lora(model,
                                  args.global_rank,
                                  args.output_dir,
